...
for param=1:numel(C)
    ...
    parfor i = 1:k
        ...
        for j = 1:num_classes
            ...
            model = fitcsvm(train', train_labels,'Standardize',true,'KernelFunction','RBF','KernelScale', 10^gamma(param), 'BoxConstraint', 5^C(i));
...
parfor i = 1:num_classes
    model = fitcsvm(x_train', y_train(:, i),'Standardize',true,'KernelFunction','RBF','KernelScale', 100.52, 'BoxConstraint', 5.2289);
